package co.karpenko.alex.data.db

import android.content.Context
import androidx.room.Database
import androidx.room.Room
import androidx.room.RoomDatabase
import co.karpenko.alex.data.db.books.BookDao
import co.karpenko.alex.data.db.remote_keys.RemoteKeys
import co.karpenko.alex.data.db.remote_keys.RemoteKeysDao

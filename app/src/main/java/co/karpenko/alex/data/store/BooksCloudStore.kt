package co.karpenko.alex.data.store

import co.karpenko.alex.data.mapper.Book
import co.karpenko.alex.data.mapper.BookMapper.toBook
import co.karpenko.alex.data.mapper.BookMapper.toBookModel
import co.karpenko.alex.data.mock_data.ApiService
